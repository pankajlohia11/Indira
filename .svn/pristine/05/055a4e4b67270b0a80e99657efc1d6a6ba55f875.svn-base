app1.controller("AC_PaymentTermsCtrl", function ($scope, $http, $window) {
    ...
    //View the deleted payment terms
    ...
    $scope.Restoredeleterecords = function (a, $event, b) {
        if (b)
        {
            alertmessageModified($event, a.toString(),b,'ET_Admin_PaymentTerms','ET_Admin_PaymentTermsr_Restore_Delete');
        }
        else {
