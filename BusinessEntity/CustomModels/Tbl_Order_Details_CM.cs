...
namespace BusinessEntity.CustomModels
{
    public class Tbl_Order_Details_CM
    {
        ...
        public bool? IS_TAXApplicable { get; set; }
    ...
    public class AvailbleStock
    {
        public decimal AvailableQty { get; set; }
        public DateTime PODate { get; set; }
        public decimal POQty { get; set; }
    }
    public class AvailbleStockView
    {
        public AvailbleStock Head { get; set; }
        public List<AvailbleStock> Detail { get; set; }
    }

    /// <summary>
    /// This Class is used to handle the MailContent Information,
    /// To,CC,Subject and Content,Attachments
    /// </summary>
    public class MailContentInfo
    {
        ...
        public decimal CompanyKey { get; set; }
        public List<MailContentAttachments> MailAttachments { get; set; }
    }

    public class MailContentAttachments
    {
        public decimal attachmentId { get; set; }
        public string attachmentPath { get; set; }
        public string attachmentUserId { get; set; }
        public string attachmentCreatedBy { get; set; }
        public DateTime? attachmentCreatedDate { get; set; }
        public bool? attachmentDeleted { get; set; }
        public decimal companyKey { get; set; }
    }

    public class Order_View_CM
    {
        public List<Tbl_Order_Details_CM> OHeader { get; set; }
        public List<Tbl_Order_Details_CM> OChild { get; set; }
    }
}
