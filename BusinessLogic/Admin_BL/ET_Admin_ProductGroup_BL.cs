...
namespace BusinessLogic.Admin_BL
{
    public class ET_Admin_ProductGroup_BL
    {
        ...
        public List<Tbl_ProductGroup> ET_Admin_ProductGrouplist_BL(int com_key)
        {
            return ObjDL.ET_Admin_ProductGrouplist_DL(com_key);
        }
        public decimal ET_Admin_ProductGroup_Add_BL(Tbl_ProductGroup obj, bool automanual, string prefix)
        {
        ...
        public List<Tbl_ProductGroup> BindDropdown_BL(int id)
        {
            return ObjDL.BindDropdown_DL(id);
        }
