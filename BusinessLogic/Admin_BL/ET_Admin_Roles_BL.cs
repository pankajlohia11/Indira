...
namespace BusinessLogic.Admin_BL
{
    public class ET_Admin_Roles_BL
    {
        ...
        public List<Tbl_Master_Role> ET_Admin_RoleList_BL(int com_key)
        {
            return ObjDA.ET_Admin_RoleList_DL(com_key);
        }
        ...
        {
            return ObjDA.Tbl_Master_Role_Add(_tbl_Master_Role, automanual, prefix, ChildData, out rolecode);
        }
        ...
        public string CheckDuplicateRoleName_BL(int id, string name)
        {
            return ObjDA.CheckDuplicateRoleName_DA(id, name);
        }
    }
}