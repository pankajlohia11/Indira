app1.controller("AC_CompanyMaster", function ($scope, $http, $window, $rootScope) {
    ...
    function validateContact() {
        ...
        var txt = "";
        //if ($scope.selectedcompanytype == 0) {
        //    if ($scope.COM_Sales_Person==0)
        //        {
        //        message = "Select The Sales Person";
        //        toastr["error"](message, "Notification");
        //        return "";
        //    }
    ...
    function validateBank() {
        ...
        for (j = 0; j < tr1.length; j++) {
            ...
            var bankaddress = $(td[1]).find("input").val();
            ...
            ////}
            ////else if (bankaddress == "") {
            ////    message = "Enter bankaddress at row:" + (j + 1);
            ////    toastr["error"](message, "Notification");
            ////    return "";
            ////}
            ////else if (bankaccNo == "") {
            ////    message = "Enter Bank Account Number at row:" + (j + 1);
            ////    toastr["error"](message, "Notification");
            ////    return "";
            ////}
            ////else if (b_swift == "") {
            ...
            ////}
            //else if (b_BLZ == "") {
            //    message = "Enter BLZ at row:" + (j + 1);
            //    toastr["error"](message, "Notification");
            //    return "";
            //}
            //else if (b_BIC == "") {
            //    message = "Enter BIC at row:" + (j + 1);
            //    toastr["error"](message, "Notification");
            //    return "";
            //}
            //else if (IBAN == "") {
            //    message = "Enter IBAN at row:" + (j + 1);
            //    toastr["error"](message, "Notification");
            //    return "";
            //}
    ...
    $scope.Restorerecords = function (a, $event, b)
    {
    ...
    $scope.Restoredeleterecords = function (a, $event, b) {
        ...
        if (b)
        {
            alertmessageModified($event, a.toString(), b, 'ET_Admin_Company', 'ET_Master_Company_RestoreDelete');
        }
        else
        {
            $scope.Restorerecords(a, $event, b);
            //message = "You don't access to do this operation, please contact admin.";
            //toastr["error"](message, "Notification");
        }
    } 
