app1.controller("AC_DocumentNotificationCtrl", function ($scope, $http, $window, $compile) {

    GetScheduleList();
    GetPrivilages();
    //get the schdule list
    function GetScheduleList() {
        var getquotationlist = $http.get("/ET_Sales_Shipment/GetShipmentDocumentListForNotifications",
            {
                params: { delete: false }
            });
