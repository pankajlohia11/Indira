app1.controller("AC_EnquiryNotificationCtrl", function ($scope, $http, $window, $compile) {
    GetPrivilages();
    GetEnquiryList();
    ...
    function GetEnquiryList() {
        var getdespatchlist = $http.get("/ET_Sales_Quotation/GetEnquiryNotinQuotationList",
            {
                params: { delete: false }
            });
