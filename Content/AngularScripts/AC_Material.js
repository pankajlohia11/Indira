app1.controller("AC_Material", function ($scope, $http, $window, $rootScope) {
    $scope.txtMaterialCodeView = "asdsad";
    GetMaterialList();
    GetPrivilages();
    ...
    $scope.Restoredeleterecords = function (a, $event, b) {
        if (b) {
            alertmessageModified($event, a.toString(), b, 'ET_Admin_Material', 'ET_Admin_Material_RestoreDelete');
        }
        else {
    ...
    $scope.ViewRecords = function (a) {
        ...
        if ($scope.Isview) {
            var post = $http({
                method: "POST",
                url: "/ET_Admin_Material/ET_Admin_Material_View",
                dataType: 'html',
                data: {
                    id: a
                },
...
//app1.controller('ParentCtrl', function ($scope, $controller, $rootScope) {
//    $rootScope.$on("CallParentMethod", function (asd, data) {
//        $scope.txtMaterialCodeView = data.a;
//        $scope.txtMaterialnameView = data.b;
//        $scope.txtDescriptionView = data.c;
//        $scope.chkCottonView = data.d;
