app1.controller("AC_ShipmentToOneTOOneInvoiceCtrl", function ($scope, $http, $window, $compile)
{
    debugger;
    ...
    function GetTheShipmentDetails()
    {
        ...
        getshipmentlist.then(function (shipmentlist) {
            debugger;
            var res = JSON.parse(shipmentlist.data);
            $scope.OTOI_CustomerID = res[0].S_CustSup;
    ...
    {
        //alert('ShipmentDetails' + $scope.OTOI_ShipmentID);
        ...
        $http({
            ...
            $scope.OTOI_Blno = total[0].data1.Bl_no;
        });
    }
