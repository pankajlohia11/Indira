   ...
   //Create the new store product
    ...
    function EnquiryDetails(e) {
        ...
        $http({
            ...
            GetProductList();
            //SequenceEnquriyDetails(function () {
    ...
    function SequenceEnquriyDetails(_callback)
    {
        _callback();
    }
    ...
    $scope.Restoredeleterecords = function (a, $event, b) {
        if (b) {
            alertmessageModified($event, a.toString(), b, 'ET_Admin_Store', 'ET_Admin_Store_Delete');
        }
        else {
    ...
    $scope.PerformRestore = function (a, $event, b) {
        var post = $http({
            method: "POST",
            url: "/ET_Admin_Store/ET_Admin_Store_Delete",
            dataType: 'json',
            data: {
                id: a,
                type: b
