app1.controller("AC_PendingShipmentDetailsCtrl", function ($scope, $http, $window, $rootScope) {
    debugger;
    ...
    $scope.GetAgencyShipmentDetails = function () {
        ...
        if ($scope.SelectedDuration == "7" && ($("#FromDate").val() == "" || $("#ToDate").val() == "")) {
            ...
            debugger;
            var getAgencyShipmentDetails = $http.get("/PendingShipmentDetails/GetAgencyShipmentDetails",
                {
                    params:
                        {
