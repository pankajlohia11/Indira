                ...
                try
                {
                    ...
                    if (lang == "E")
                    {
                        for (int i = 0; i < obj.Head.Count; i++)
                        {
                            ...
                            cell26Processby3.HorizontalAlignment = 2;
                            ...
                            float[] widths1 = new float[] { 5f, 10f, 10f, 35f,  20f, 20f };
                            ...
                            if (obj.Head[i].Zipcode == 82)
                            {
                                ...
                                inccell.AddElement(new Paragraph(new Chunk(Convert.ToDecimal(obj.Head[i].VatPer).ToString("0") + " % Value", font)));
                                inccell.Colspan = 5;
                            ...
                            if (obj.Head[i].PaymentName != string.Empty)
                            {
                            ...
                            if (obj.Head[i].SHIPMENT != string.Empty)
                            {
                    ...
                    if (lang == "G")
                    {
                        for (int i = 0; i < obj.Head.Count; i++)
                        {
                            ...
                            for (int j = 0; j < obj.Detail.Count; j++)
                            {
                                ...
                                table4.AddCell(cell52);
                                //German Text for UOM
                                string uomText = obj.Detail[j].UOM_NAME;
                                if (obj.Detail[j].UOM_CODE == "1")
                                    uomText = "Kg";
                                else if (obj.Detail[j].UOM_CODE == "2")
                                    uomText = "Mtrs";
                                else if (obj.Detail[j].UOM_CODE == "3")
                                    uomText = "Stk";
                            ...
                            if (obj.Head[i].Zipcode == 82)
                            {
                                ...
                                inccell.AddElement(new Paragraph(new Chunk(Convert.ToDecimal(obj.Head[i].VatPer).ToString("0") + "% USt.", font)));
                                inccell.Colspan = 5;
                                inccell.PaddingTop = 2.5f;
                                inccell.PaddingBottom = 2.5f;
                            ...
                            if (obj.Head[i].PaymentName != string.Empty)
                            {
                                ...
                                //    doc1.NewPage();
                                //}
                                cell33.AddElement(new Paragraph(new Chunk("Zahlungsbedingungen: " + obj.Head[i].PaymentName + "", font)));
                            ...
                            {
                                PdfPCell delitercell = new PdfPCell();
                                delitercell.AddElement(new Paragraph(new Chunk("Lieferbedingungen: " + obj.Head[i].SHIPMENT + "", font)));
                                delitercell.PaddingTop = 2.5f;
                                delitercell.PaddingBottom = 2.5f;
                                delitercell.Border = 0;
                                table7.AddCell(delitercell);
                            ...
                            {
                                PdfPCell signcell = new PdfPCell();
                                signcell.AddElement(new Paragraph(new Chunk("Gültigkeitstage: " + obj.Head[i].VALIDITY_DAYS + "", font)));
                                signcell.PaddingTop = 0f;
                                signcell.PaddingBottom = 2.5f;
                                signcell.Border = 0;
                                table7.AddCell(signcell);
