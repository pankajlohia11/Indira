...
namespace Euro.Controllers.Admin
{
    public class ET_Admin_PaymentTermsController : Controller
    {
        ...
        private string validations(decimal pamentID, string txtpamentCode, string txtPaymentName,string txtDetails)
        {
        ...
        //Insert/update the payment terms
        [HttpPost]
        public JsonResult ET_Admin_PaymentTerms_Add(decimal pamentID, string txtpamentCode, string txtPaymentName, string txtDetails)
        {
            bool val = Session["UserID"] == null ? false : true;
            if (val)
            {
                try
                {
                    string valid = validations(pamentID, txtpamentCode, txtPaymentName,txtDetails);
                    if (valid == "")
                    {
