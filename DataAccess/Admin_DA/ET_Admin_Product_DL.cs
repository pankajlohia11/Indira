            ...
            try
            {
                if (obj.P_ID == 0)
                {
                    Tbl_Product_Master objtpy = new Tbl_Product_Master()
                    {
                        ...
                        P_PackingQuantityUOM=obj.P_PackingQuantityUOM,
                        P_IsStock = obj.P_IsStock,
                        P_ROL = obj.P_ROL,
                        P_MSL = obj.P_MSL,
                        DELETED = false,
                        CREATED_DATE = DateTime.Now,
                ...
                else
                {
                    Tbl_Product_Master objtpy = dbcontext.Tbl_Product_Master.Single(m => m.P_ID == obj.P_ID);
                    {
                        ...
                        objtpy.P_PackingQuantityUOM = obj.P_PackingQuantityUOM;
                        objtpy.P_IsStock = obj.P_IsStock;
                        objtpy.P_ROL = obj.P_ROL;
                        objtpy.P_MSL = obj.P_MSL;
